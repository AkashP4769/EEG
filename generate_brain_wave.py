...
def generate_focused_brain_wave():
    ...
    focused_bw.visualize_data(heading="Default Focused Brain Wave")
    ...
    focused_bw_custom.visualize_data(heading="Custom Focused Brain Wave")
...
def generate_unfocused_brain_wave():
    ...
    unfocused_bw.visualize_data(heading="Default Unfocused Brain Wave")
    ...
    unfocused_bw_custom.visualize_data(heading="Custom Unfocused Brain Wave")
